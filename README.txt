                    Bitnami WordPress Stack 5.2.4-1
                  ==============================
...
bitnami-wordpress-5.2.4-1-linux-x64-installer.run on Linux 64 bit or
bitnami-wordpress-5.2.4-1-windows-installer.exe on Windows or
bitnami-wordpress-5.2.4-1-osx-x64-installer.dmg on OS X.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-wordpress-5.2.4-1-linux-x64-installer.run
...
in /home/user/wordpress-5.2.4-1 on Linux or
C:\Bitnami\wordpress-5.2.4-1 on Windows or
/Applications/wordpress-5.2.4-1 on OS X and that you use port 8080
...
/home/user/wordpress-5.2.4-1/apache2/logs/error.log on Linux or
C:\bitnami\wordpress-5.2.4-1\apache2\logs\error.log on Windows or
/Applications/wordpress-5.2.4-1/apache2/logs/error.log.
